...
<div class="page-break">
  ...
  <p>The primary empirical artifact of this research is the <strong>NepaliNutriDB</strong> dataset. To establish complete scientific defensibility and eliminate speculative approximations, all composite Nepali dishes were transitioned to a <strong>100% mathematically derived recipe aggregation architecture</strong>. Composite foods are computed as deterministic linear combinations of verified raw agricultural building blocks cataloged in USDA FoodData Central Foundation Foods [8] and the Food Composition Table for Nepal published by the Government of Nepal (DFTQC / FAO) [7]:</p>

  <div class="equation-box">
    Nutrient<sub>dish</sub> = &sum;<sub>i=1..k</sub> ( Nutrient<sub>i,per 100g</sub> &times; w<sub>i</sub> / 100 )
    <span class="eq-num">(4.1)</span>
  </div>

  <p>where w<sub>i</sub> represents the gram weight of ingredient <em>i</em> in a standard culinary preparation, and &sum; w<sub>i</sub> = serving_size_g. The operational database comprises <strong>129 verified foods</strong> (124 authentic Nepali culinary preparations and 5 international dietary staples): <strong>64 composite cooked dishes</strong> derived from verified recipes, <strong>35 foundation commodities</strong> directly from USDA FoodData Central, <strong>25 indigenous staples</strong> from FAO Nepal 2012, and <strong>5 traditional grain preparations</strong> from NARC.</p>
  ...
  <table class="report-table">
    ...
    <tbody>
      <tr><td><strong>Classification Accuracy (&tau; = 0.5)</strong></td><td><strong>93.33%</strong></td><td>90.00%</td></tr>
      <tr><td><strong>Precision</strong></td><td><strong>100.00%</strong></td><td>100.00%</td></tr>
      <tr><td><strong>Recall</strong></td><td><strong>84.62%</strong></td><td>76.92%</td></tr>
      <tr><td><strong>F1-Score</strong></td><td><strong>0.9167</strong></td><td>0.8696</td></tr>
      <tr><td><strong>Mean Absolute Error (MAE)</strong></td><td><strong>0.0317</strong></td><td>0.0386</td></tr>
      <tr><td><strong>Root Mean Squared Error (RMSE)</strong></td><td><strong>0.0396</strong></td><td>0.0500</td></tr>
      <tr><td><strong>Coefficient of Determination (R²)</strong></td><td><strong>0.9116</strong></td><td>0.8592</td></tr>
      <tr><td>Score Spread Range</td><td>0.064 — 0.899</td><td>0.082 — 0.862</td></tr>
      <tr><td>Standard Deviation (&sigma;)</td><td>0.150</td><td>0.140</td></tr>
    </tbody>
  </table>

  <p><strong>Performance Analysis:</strong> XGBoost achieved an outstanding <strong>R² score of 0.9116</strong> on the mathematically verified dataset and an exceptionally low <strong>MAE of 0.0317</strong>. In classification evaluation (&tau; = 0.5), it achieved <strong>93.33% accuracy</strong>, a high recall of <strong>84.62%</strong>, and a flawless <strong>100.00% precision</strong> (F1-score = 0.9167). This guarantees that every food recommended by the model as nutritionally superior is genuinely wholesome, completely avoiding false-positive recommendations of low-quality foods.</p>
</div>
...
<div class="page-break">
  ...
  <div class="reference-item">[2] R. U. Haque, R. H. Khan, A. S. M. Shihavuddin, M. M. Syeed, and M. F. Uddin, "Lightweight and Parameter-Optimized Real-Time Food Calorie Estimation from Images Using CNN-Based Approach," <em>Applied Sciences</em>, vol. 12, no. 19, p. 9733, 2022. DOI: 10.3390/app12199733.</div>
  <div class="reference-item">[3] T. A. Adjuik, N. A. A. Boi-Dsane, and B. A. Kehinde, "Enhancing dietary analysis: Using machine learning for food caloric and health risk assessment," <em>Journal of Food Science</em>, vol. 89, no. 11, pp. 8006–8021, 2024. DOI: 10.1111/1750-3841.17421.</div>
  <div class="reference-item">[4] S. M. Sefa-Yeboah, K. O. Annor, V. J. Koomson, F. K. Saalia, M. Steiner-Asiedu, and G. A. Mills, "Development of a Mobile Application Platform for Self-Management of Obesity Using Artificial Intelligence Techniques," <em>International Journal of Telemedicine and Applications</em>, vol. 2021, Article ID 6624057, 2021. DOI: 10.1155/2021/6624057.</div>
  ...
  <div class="reference-item">[6] D. W. Kim, H. Lee, M. K. Kim, and S. W. Kang, "Qualitative evaluation of artificial intelligence-generated weight management diet plans," <em>Frontiers in Nutrition</em>, vol. 11, Article 1374834, 2024. DOI: 10.3389/fnut.2024.1374834.</div>
